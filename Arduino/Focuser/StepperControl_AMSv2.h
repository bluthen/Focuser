...
History:
Version 1.0AMSv2 - Author Russell Valentine
   AMSv2 version
...
#ifndef stepperControl_AMSv2_h
#define stepperControl_AMSv2_h
...
class StepperControl_AMSv2 {
public:
    //DEBUG
    long dbg_correction;

    // Constructors:
    StepperControl_AMSv2(uint8_t port);
